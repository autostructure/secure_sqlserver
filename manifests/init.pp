...
class secure_sqlserver (
  ...
  class { '::secure_sqlserver::controller':
    ...
    db_master_key_encrypt_backup_file_filepath => $::secure_sqlserver::db_master_key_encrypt_backup_file_filepath,
    db_master_key_encrypt_backup_file_password => $::secure_sqlserver::db_master_key_encrypt_backup_file_password,
