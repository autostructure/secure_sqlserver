# sqlserver_database_roles_and_users_with_modify.rb
#
# Dependencies:
# v79081
#
...
Facter.add('sqlserver_database_roles_and_users_with_modify') do
...
"
    ...
    Puppet.debug "sqlserver_database_roles_and_users_with_modify.rb sql...\n#{sql}"
