...
Facter.add('sqlserver_v79165_file_changes') do
  ...
  setcode do
    ...
    cmd3 = "Compare-Object $(Get-Content 'c:\\puppet.secure-sqlserver.filehash-baseline.json') $(Get-Content 'c:\\puppet.secure-sqlserver.filehash-tempfile.json') | Format-Table -HideTableHeaders"# lint:ignore:140chars
